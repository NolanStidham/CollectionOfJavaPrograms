 ...
 * Computer Science 2 
 * Nolan Stidham 
 * Assignment Number: 17.7 
 * Date Last Edited: 4/5/17 
        ...
        try {
            try (ObjectOutputStream outputDat =
                ...
                for (int i = 0; i < numOfLoans; i++) {
                    double interest = 6.5;
                    int years = (int) (Math.random() * (49)) + 1;
                    double intAmount = Math.random() * 20000;
            ...
            try (ObjectInputStream inputDat =
                ...
                while (true) {
                    ...
                    sumOfLoanPayment = sumOfLoanPayment
                            + currentLoan.getTotalPayment();
                    counter++;
                }
